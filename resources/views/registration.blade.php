...
<article class="card-body mx-auto" style="max-width: 400px;">
	...
	<p class="text-center">Remplissez le formulaire</p>
	...
	<div class="form-group input-group">
        ...
        <input name="username" class="form-control" placeholder="Prenoms" type="text">
    </div> <!-- form-group// -->
    ...
    <div class="form-group input-group">
        ...
        <input name="birthday" class="form-control" placeholder="Date de naissance" type="date">
    </div>
